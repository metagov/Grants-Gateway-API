...
Before writing any code, gather comprehensive information about the grant system:

#### A. API Documentation Review
```bash
# Document the following for each entity type:
