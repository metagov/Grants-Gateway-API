...
export default function HealthPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg border-r border-gray-200 transform transition-transform duration-200 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} lg:translate-x-0`}
      >
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
              <div>
                <p className="text-sm md:text-base text-gray-600">
                  Real-time status of grant system integrations and API
                  components
                </p>
              </div>
                      ...
                      <CardContent className="space-y-4">
                        ...
                        {adapter.error && (
                          <div className="p-3 bg-red-50 bg-red-900/20 rounded-lg">
                            <div className="text-xs md:text-sm text-red-600 text-red-400 font-medium">
                              Error:
                            </div>
                            <div className="text-xs md:text-sm text-red-500 text-red-300 break-words">
                              {adapter.error}
                            </div>
                          </div>
                        )}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-xs md:text-sm text-gray-600 text-gray-300">
                          ...
                          data can be accesed via daoip5.daostar.org endpoint:
                        </p>
                        <ul className="text-xs md:text-sm space-y-1">
                          <li className="flex items-center">
                            <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
